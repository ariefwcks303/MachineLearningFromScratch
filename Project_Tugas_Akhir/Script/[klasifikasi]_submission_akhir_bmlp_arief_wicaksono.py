# -*- coding: utf-8 -*-
"""[Klasifikasi]_Submission_Akhir_BMLP_Arief-Wicaksono.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18p77TLxlxuBFvJTLCVdGh8StKKmYxkvN
...
df_clustering_inverse = pd.read_csv("/content/data_clustering_inverse.csv")
...
categorical_cols = list(df_clustering_inverse.select_dtypes(include=['object']).columns)

# Gunakan 'pd.get_dummies' untuk melakukan OneHotEncoding
df_encoded = pd.get_dummies(
    df_clustering_inverse,
...
joblib.dump(new_model_tuned, 'tuning_RandomForest_classification.h5')
